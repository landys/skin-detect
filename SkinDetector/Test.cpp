...
int main()
{
	//trainBayesModel("E:\\pic_skindetect\\result\\data\\pic_names.dat", "E:\\pic_skindetect\\result\\data\\bayesSkin.model");
	loadBayesModel("E:\\pic_skindetect\\result\\data\\bayesSkin.model");
